...
app.get('/sendWeatherAPI', (req, res) => {
    var options = {
        'method': 'GET',
        'url' :  'http://dataservice.accuweather.com/currentconditions/v1/1123655?apikey=tOULVT9iIbIuMe8OYCTufUofnr78o5j1'
    };
    ...
    request(options, function (error, response){
        ...
        res.render('weather', {title: 'Weather App', city: "Hong Kong", weather: weather, temp: temp, unit: unit, time: time, date: date});
    });
})
app.get('/', (req, res) => {
    res.render('index', {title: 'Weather App', city: "Hong Kong"});
